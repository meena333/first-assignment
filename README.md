...
Implementation ( by Meenakshi Venkat):
I was able to get all the 19 tests to pass.
For the Section 4, I attempted all except the 4th item (implement fighting an enemy). I didn't have a good understanding of this game logic hence I didn't know where to begin doing this. For the other items in Section 4, I've implemented only the simple 'happy' path due to time constraints.
